...
<h2>Overview</h2>
<p>This is a <strong>Java-based Hotel Management System</strong> with a GUI built in NetBeans. It simulates a hotel front-desk system, allowing an admin to manage guests and room availability.</p>
